...
class LTXModelConfigurator(ModelConfigurator[LTXModel]):
    ...
    def from_config(cls: type[LTXModel], config: dict) -> LTXModel:
        ...
        return LTXModel(
            ...
            rote_gamma=config.get("rote_gamma", 1.0),
            rote_alpha=config.get("rote_alpha", 1.0),
            temporal_mode=config.get("temporal_mode", "tcr"),
            tcr_beta=config.get("tcr_beta", 5.0),
            tcr_alpha=config.get("tcr_alpha", 1.0),
        )
